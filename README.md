...
- Проведён глубокий аудит русского перевода по сравнению с оригинальными данными игры.
- Исправлены псевдо-токены и английские глагольные токены, включая `is` и `has`.
- Исправлены потерянные и перепутанные actor-токены (`[us]`, `[them]` и падежные варианты).
- Исправлены смысловые ошибки в медицинских действиях, добыче, сне, расслаблении, курении, использовании киосков и вскрытии контейнеров.
- Исправлены сюжетные описания Whodunnit, Merga, Meat и Ceres.
- Переведены видимые placeholder-тексты, сюжетные цели и внутренние заголовки.
- Восстановлены пропущенные абзацы в описаниях предметов, data-файлов и подпольных ящиков.
- Исправлены английские фрагменты интерфейса заданий и навигации.
- Уточнены названия повреждённых кислородных баллонов и тяжёлых состояний.
- Обновлён BepInEx-плагин до версии `3.2.2`.
